let template = `
    ...
    >
      ...
      <ext-textfield id="myget_first" required="true" placeholder="First Name*"></ext-textfield>
      <ext-textfield
          id="myget_last"
          required="true"
      ...
      <sencha-field-country id="myget_country" style="display: block;"></sencha-field-country>
