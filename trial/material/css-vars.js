...
__rt_setDynamic("$base-color", __rt_getGlobalDefault("$base_color") || __ColorRGBA.fromHex("#163D72"), 1);
...
__rt_setDynamic("$confirm-color", __rt_getGlobalDefault("$confirm_color") || __ColorRGBA.fromHex("#3D7216"), 19);
__rt_setDynamic("$confirm-pressed-color", __rt_getGlobalDefault("$confirm_pressed_color") || (__rt_test(__rt_get("$dark_mode")) ? __rt_box(__rt.registered.darken.apply(__rt.registered, __rt_applySpreadArgs([
    ...
    __rt_get("$confirm_color"), 
    new __Numeric(15, "%")])))), 20);
__rt_setDynamic("$alert-color", __rt_getGlobalDefault("$alert_color") || __ColorRGBA.fromHex("#72163D"), 21);
...
__rt_setDynamic("$background-color", __rt_getGlobalDefault("$background_color") || __ColorRGBA.fromHex("#fff"), 33);
