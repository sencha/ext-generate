...
<div class="outer">
  ...
  <button class="copy tooltip" onclick="copyToClipboard('npm login --registry=https://sencha.myget.org/F/{feed}/npm/ --scope=@sencha')"><span class="fas fa-clipboard"></span><span class="tooltiptext">Copy to Clipboard</span></button>
</div>
