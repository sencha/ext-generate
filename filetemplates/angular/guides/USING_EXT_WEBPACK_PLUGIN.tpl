...
[For ext-angular-{toolkit}{bundle}](https://github.com/sencha/ext-angular/blob/ext-angular-7.1.1/packages/ext-angular-{toolkit}{bundle}/GETTING_STARTED.md)
...
"gzip-cli": "^1.0.1",
"http-server": "^0.11.1",
"@sencha/ext-angular-{toolkit}{bundle}": "~7.1.1",
"@sencha/ext": "^7.0.0",
...
```sh
npm install --save @sencha/ext-angular{toolkit}{bundle} @sencha/ext @sencha/ext-{toolkit} @sencha/ext-{toolkit}-theme-material
