...
<div style="padding-left:10px;font-size:24px;height:100%;background: red;">
    ExtAngular 7.0 Documentation

  <div style="xheight:900px;padding:10px;" class="frame thelist">{includedxtypes}</div>
</div>
